    ...
    <form onSubmit={handleSubmit(onSubscribe)} className="w-full bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6 md:max-w-[440px]">
      ...
      <div className="space-y-3">
        <div className="space-y-2">
          ...
          {errors?.name && <p className="text-danger font-semibold text-xs">{errors.name.message}</p>}
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors?.email && <p className="text-danger font-semibold text-xs">{errors.email.message}</p>}
        </div>
      </div>
